...
- **[conditional-race](https://github.com/rodrigogs/conditional-race)**: Just like `Promise.race()`, but the winner will be the first one to win the race and fulfils a condition
